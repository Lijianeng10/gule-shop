    ...
    <div class="about_home">
        ...
        <div class="container">
            <ul>
                    ...
                    <ul>
                        <li>
                            <router-link to="/about/orderList/obligation">
                                <el-badge :value="stayPay" class="item">
                        ...
                        <li>
                            <router-link to="/about/orderList/delivery">
                                <el-badge :value="staySend" class="item">
                        ...
                        <li>
                            <router-link to="/about/orderList/harvest">
                                <el-badge :value="stayReceive" class="item">
                        ...
                        <li>
                            <router-link to="/about/orderList/ratings">
                                <el-badge :value="finish" class="item">
                        ...
                        <li>
                            <router-link to="/about/orderList/drawback">
                                 <el-badge :value="refund" class="item">
                ...
                <router-link to="/about/personInfo">
                    <li>
                        <span class="list-icon">
...
export default {
  ...
  mounted: function () {
      ...
      this.axios.post('/api/front/order/get-user-order-num', strData).then(function (response) {
          ...
          that.stayReceive = result.stayReceive!==null?result.stayReceive:0;
          that.finish = result.finish!==null?result.finish:0;
          that.refund = result.refund!==null?result.refund:0;
      })
  }
}
</script>
